...
public class PersianIdentityError : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"کدملی '{userName}' نامعتبر است، فقط می تواند حاوی اعداد باشد." }; }
    ...
    public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"این نام کدملی '{userName}' به کاربر دیگری اختصاص یافته است." }; }
